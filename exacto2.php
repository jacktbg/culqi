...
<body>
	...
	<div style="margin-left: 100px" class="col-sm-6">
    	...
    	<h4> Monto total a pagar: <input type="text" name="precio" value="<?php echo $e ?>" disabled>
    </h4>
	...
	<div class="row">
		<div  style="margin-left: 100px; margin-top:10px" class="col-sm-5">
				<h3>Modo de pago</h3>
				<input type="radio" name="option" value="culqi" id="tarjetas_option" onclick="changeFormula('logos/tarjetas.png');" disabled>Tarjeta de Crédito
				<input type="radio" name="option" value="paypal" id="paypal_option" onclick="changeFormula('logos/paypal.png');" checked>Paypal
				<br>
				<img src="logos/paypal.png" name="theimage" id="theimage" style="border: 2px solid  #DFDDDD" class="woa">
		</div>
	...
	<div class="container" style="margin-top: 10px">
      ...
      <input type="hidden" name="business" value="stevenoblea@andeanperutour.com">
      <input type="hidden" name="lc" value="AR">
      <input type="hidden" name="item_name" value="<?php echo $b ?>">
      <input type="hidden" name="item_number" value="2">
      <input type="hidden" name="amount" value="<?php echo $e ?>">
